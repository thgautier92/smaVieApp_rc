...
/*
  Generated class for the Souscription page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-souscription',
...
export class Souscription {
  ...
  ionViewDidLoad() {
    console.log('Hello Souscription Page');
  }
  ngOnInit() {
    this.getHistoSimu();
  ...
  openClause(cl) {
    console.log(cl);
    if (cl['form'] != "") {
      let modal = this.modalCtrl.create(ClauseDetail, { "idClient": this.idClient, "idForm": cl['form'], "dataIn": this.dataIn });
      modal.present();
    }
  }
