...
export class Simuler {
  ...
  startSimu(id, simulator) {
    return new Promise((resolve, reject) => {
      ...
      let loading = this.display.displayLoading("Envoie des données au simulateur", 10);
  ...
  getSimu(simulator) {
    let loading = this.display.displayLoading("Reception des données du simulateur", 10);
